export default [
  {
    paletteName: 'Palette Flat Colors',
    id: 'palette-flat-colors',
    emoji: '✏️',
    colors: [
  ...
  {
    paletteName: 'Mooncake color',
    id: 'flat-ui-moon-cake-color',
    emoji: '🥮',
    colors: [
  ...
  {
    paletteName: 'Colorful Donut Colors',
    id: 'colorful-donut-colors',
    emoji: '🍩',
    colors: [
      { name: 'HotPink', color: '#FFAEBC' },
      { name: 'TiffanyBlue', color: '#A0E7E5' },
      { name: 'MintGreen', color: '#B4F8C8' },
      { name: 'CakeYellow', color: '#FBE7C6' },
